          ...
          ordered: [
            ...
            { actionButtonQuery: "" },
            {
              actionButtonInternalUrlPath:
                "0e7a2e1c-c658-11ee-8e2f-4b040755b508",
            },
            {
...
This is assigned when the value set is first created and cannot be edited afterward. It is consistent across all versions of the value set."
      verticalAlign="center"
    />
  </View>
  <View id="3" label="Create New Version" viewKey={3}>
    ...
    >
      <Text
        id="text14"
        value="This will create **version {{value_set_versions.data.version[0]+1}}** of the **{{load_vs_metadata.data.title}}** value set."
        verticalAlign="center"
      />
      <TextInput
        id="textInput4"
...
"
      ...
      <Button
        ...
        text="Create version {{value_set_versions.data.version[0]+1}} of {{load_vs_metadata.data.title}}"
      />
      <Event
        event="submit"
        method="trigger"
