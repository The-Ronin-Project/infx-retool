  ...
  <View id="0" label="Versions" viewKey={0}>
    <TableLegacy
      ...
      actionButtons={[
          ...
          ordered: [
            ...
            { actionButtonQuery: "" },
            {
              actionButtonInternalUrlPath:
                "d857ece0-c655-11ee-b2a8-831adcf813f2",
            },
            {
        ...
        },
        {
          ordered: [
            ...
            {
              actionButtonInternalUrlPath:
                "ca1ee336-c655-11ee-8323-838bb8d91f44",
            },
            {
              actionButtonInternalUrlQuery:
                '"[{\\"key\\":\\"concept_map_version_uuid\\",\\"value\\":\\"{{versions_table.selectedRow.data.uuid}}\\"}]"',
        ...
        },
        {
          ordered: [
            ...
            {
              actionButtonInternalUrlPath:
                "98835834-c655-11ee-883b-03c635188ef3",
            },
            {
              actionButtonInternalUrlQuery:
                '"[{\\"key\\":\\"concept_map_version_uuid\\",\\"value\\":\\"{{versions_table.selectedRow.data.uuid}}\\"}]"',
      ...
      columnWidths={[
        ...
        { object: { id: "migrate", value: 70 } },
        { object: { id: "published_date", value: 151.203125 } },
      ]}
      customButtonName=""
...
Any existing mappings which are still valid for the most recent versions of the target and source terminologies will be copied to the new version."
    ...
    <Text
      id="text5"
      value="**New Version Creation not avaible at this time.**"
      verticalAlign="center"
    />
    <Button
      id="button1"
      ...
      disabled="true"
      styleVariant="solid"
      text="Create new version of {{load_concept_map_version_metadata.data.title[0]}}"
    >
      <Event
        event="click"
        method="trigger"
