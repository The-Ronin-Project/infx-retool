...
left join custom_terminologies.code ctc on sc.custom_terminology_code_uuid = ctc.uuid where sc.concept_map_version_uuid = {{urlparams.concept_map_version_uuid}}
